  ...
  <div class="page-content pb-0">
            ...
            <figure class="member-media">
              ...
              <figcaption class="member-overlay">
                <div class="member-overlay-content">
                  ...
                  <!-- End .member-title -->
                  <p>
                    Sed pretium, ligula sollicitudin viverra, tortor libero sodales leo,
                    eget blandit nunc.
                  </p>
    ...
    <div class="about-testimonials bg-light-2 pt-6 pb-6">
      <div class="container">
        ...
        <div
          class="owl-carousel owl-simple owl-testimonials-photo owl-loaded owl-drag"
          data-toggle="owl"
          data-owl-options='{
                                "nav": false, 
                                "dots": true,
            ...
            >
              ...
              <div class="owl-item" style="width: 1168px; margin-right: 20px">
                <blockquote class="testimonial text-center">
                  ...
                  <p>
                    “ Impedit, ratione sequi, sunt incidunt magnam et. Delectus obcaecati
                    optio eius error libero perferendis nesciunt atque dolores magni
                    recusandae! Doloremque quidem error eum quis similique doloribus natus
                    qui ut ipsum.Velit quos ipsa exercitationem, vel unde obcaecati
                    impedit eveniet non. ”
                  </p>
