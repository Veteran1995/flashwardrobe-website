          ...
          <div class="col-lg-6">
            <div class="banner-set-content text-center">
              <div class="set-content-wrapper">
                ...
                <p>
                  Get on our exclusive email list and be the first to hear about
                  sales, coupons, new arrivals and more!
                </p>
                    ...
                    <div class="products">
                      ...
                      <div class="col-6">
                        <div class="product product-2 text-center">
                          ...
                          <div class="product-body">
                            <h3 class="product-title">
                              <a href="product.html">Linen-blend trousers</a>
                            </h3>
                            <!-- End .product-title -->
            ...
            <div class="banner-set-image banner-border-hover">
              ...
              <div class="banner-content">
                <h3 class="banner-title">
                  <a href="#"
                    ><span>Casual basics and<br />trendy key pieces.</span></a
                  >
                </h3>
                <!-- End .banner-title -->
